...
python ./run_multiple_choice_test.py --task_name custom --model_name_or_path deepset/roberta-base-squad2 --do_train --do_predict --do_eval --data_dir ./data/final --learning_rate 5e-5 --num_train_epochs 10  --max_seq_length 80 --output_dir models_bert/custom_base --per_device_eval_batch_size=16 --per_device_train_batch_size=16 --gradient_accumulation_steps 2 --overwrite_output
