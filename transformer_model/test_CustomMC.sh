...
python ./run_multiple_choice_test.py --task_name CustomMC --model_name_or_path models_bert/customMC_base --do_predict --data_dir ./data/CustomMC --max_seq_length 80 --output_dir models_bert/customMC_base --overwrite_output --tokenizer_name elgeish/cs224n-squad2.0-albert-base-v2
