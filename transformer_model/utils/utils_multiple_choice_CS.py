...
class CustomMCProcessor(DataProcessor):
    """Processor for the SWAG data set."""
    ...
    def _create_examples(self, lines: List[List[str]], type: str):
        """Creates examples for the training and dev sets."""
        #context,question,label,answerA,answerB,answerC,answerD,answerE,id
    ...
    #context,question,label,answerA,answerB,answerC,answerD,answerE,id
        examples = [
            InputExample(
                ...
                # common beginning of each
                # choice is stored in "sent2".
                contexts=[line[0],line[0],line[0],line[0],line[0]],
...
class WinograndeMCProcessor(DataProcessor):
    """Processor for the SWAG data set."""
    ...
    def _create_examples(self, lines: List[List[str]], type: str):
        ...
        if type == "train" and lines[0][2] != "label":
            raise ValueError("For training, the input file must contain a label column.")
            #ID,question,label,answerA,answerB,answerC,answerD,answerE
            #ID,question,label,answerA,answerB,answerC,answerD,answerE
        examples = [
            InputExample(
                example_id=line[0], #index
                question=line[1],  # in the  swag dataset, the
                # common beginning of each
                # choice is stored in "sent2".
                contexts=[line[1],line[1],line[1],line[1],line[1]],
...
class WinograndeProcessor(DataProcessor):
    ...
    def _create_examples(self, lines: List[List[str]], type: str):
        ...
        if type == "train" and lines[0][-1] != "label":
            raise ValueError("For training, the input file must contain a label column.")
            #ID,question,label,answerA,answerB,answerC,answerD,answerE
            #ID,question/context,option1,option22,label
        examples = [
            InputExample(
                example_id=line[0], #index
                question=line[1],  # in the  swag dataset, the
...
processors = {"race": RaceProcessor, "CS": CSProcessor, "arc": ArcProcessor, "syn": SynonymProcessor,"protoqa": protoqaProcessor, "CustomMC":CustomMCProcessor, "Winogrande": WinograndeMCProcessor, "Winogrande_2": WinograndeProcessor}
MULTIPLE_CHOICE_TASKS_NUM_LABELS = {"race", 4, "CS", 5, "arc", 4, "syn", 5, "protoqa", 4, "CustomMC",5, "Winogrande",5, "Winogrande_2", 2}
